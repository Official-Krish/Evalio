    ...
    <section>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              {monthFilter
                ? monthFilter.toLocaleDateString("en-US", {
                    month: "short",
                    year: "numeric",
                  })
                : "Month"}
              ...
              >
                <Calendar
                  ...
                  classNames={{
                    ...
                    month: "w-full",
                    month_caption:
                      "text-xs font-medium text-[var(--color-text)] px-2 py-1",
      ...
      <div>
        {paginated.map((interview) => {
          ...
          const prevScore =
            globalIndex < completed.length - 1
              ? (completed[globalIndex + 1]?.overallScore ?? null)
              : null;
