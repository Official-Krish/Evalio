...
const dimensions = [
  {
    ...
    story: "Did your story have a beginning, tension, and resolution — or did it wander?",
  },
  {
    label: "Product Thinking",
    short: "Code connected to outcomes",
    story: "Can you explain why this feature matters to a user, not just how you'd build it?",
  },
  {
  ...
  },
  {
    ...
    story: "Do you wait for direction, or do you frame the problem and propose a path?",
  },
  {
  ...
  },
  {
    ...
    story: "When corrected mid-session, did you adapt — or repeat the same mistake?",
  },
]
    ...
    <section ref={sectionRef} className="landing-container relative py-[16vh] border-b">
      ...
      >
        ...
        <h2 className="landing-display text-[clamp(1.85rem,3.8vw,2.85rem)] leading-[1.08] tracking-[-0.03em] text-[var(--landing-fg)]">
          Not a score.{" "}
          <span className="landing-serif italic text-[var(--landing-fg-muted)]">A landscape.</span>
        </h2>
        <p className="mt-5 text-[14px] leading-[1.8] text-[var(--landing-fg-muted)]">
          Pass/fail tells you nothing useful. Six peaks show where you stood tall,
          where you dipped, and exactly what to climb next.
        </p>
      </motion.div>
              ...
              >
                <motion.span
                  ...
                  animate={{
                    ...
                    backgroundColor: isActive ? "var(--landing-accent)" : "var(--landing-line)",
                    boxShadow: isActive
