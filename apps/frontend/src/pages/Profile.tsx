...
export function ProfilePage() {
  ...
  const totalMinutes = completed.reduce(
    (sum, i) =>
      sum + (i.durationSeconds ? Math.round(i.durationSeconds / 60) : 0),
    0,
  );
  const avgScore =
    completed.length > 0
  ...
  const githubUsername = userData?.user?.candidate?.githubUsername ?? null;

  return (
    <div
      style={{ maxWidth: "900px", margin: "0 auto", paddingBottom: "48px" }}
      className="py-6"
    >
      {/* ─── Profile Banner ────────────────────────── */}
      <div
      ...
      >
        ...
        <div
          style={{
            height: "120px",
            background:
              "linear-gradient(135deg, var(--landing-bg, #080808) 0%, rgba(184,168,138,0.06) 40%, var(--landing-bg, #080808) 100%)",
            position: "relative",
            overflow: "hidden",
          }}
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                "repeating-linear-gradient(90deg, transparent, transparent 59px, var(--landing-line, rgba(236,234,230,0.06)) 59px, var(--landing-line, rgba(236,234,230,0.06)) 60px)",
              opacity: 0.5,
            }}
          />
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                "repeating-linear-gradient(0deg, transparent, transparent 29px, var(--landing-line, rgba(236,234,230,0.06)) 29px, var(--landing-line, rgba(236,234,230,0.06)) 30px)",
              opacity: 0.5,
            }}
          />
          {/* Accent glow */}
          <div
            style={{
              ...
              height: "200px",
              background:
                "radial-gradient(ellipse, var(--app-accent-glow, rgba(184,168,138,0.1)) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
        </div>
          ...
          >
            ...
            <div
              style={{
                ...
                boxShadow:
                  "0 0 0 1px var(--app-accent-border, rgba(184,168,138,0.3))",
                flexShrink: 0,
                position: "relative",
              }}
            >
